...
const agencySchema = new mongoose.Schema({
    ...
    num_cnss : {
        type : String,
        unique : true,
        required : [true, "Your cnsssss number is required"],
        maxlength : [7 , "Your cnsssss number must contain 7 characters"],
        minlength:[7, "Your cnsssss number must contain 7 characters "],
